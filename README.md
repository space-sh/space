...
# Space | [![build status](https://gitlab.com/space-sh/space/badges/master/build.svg)](https://gitlab.com/space-sh/space/commits/master) [![latest stable version](https://img.shields.io/badge/latest%20stable-0.11.0-blue.svg?style=flat)](https://gitlab.com/space-sh/space/tags/0.11.0)
...
```
mkdir space
curl https://space.sh/static/download/space-0.11.0/space-0.11.0.tar.gz | tar xvfz - -C ./space && cd ./space && ./space /install/
```
