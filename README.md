...
```
mkdir space
curl https://space.sh/static/download/space-0.15.0/space-0.15.0.tar.gz | tar xvfz - -C ./space && cd ./space && ./space /install/
```
