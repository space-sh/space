...
_RUN_CHECK_OK "Test space install: no parameters" "\[SUCCE\] SPACE_INSTALL_BIN:" space /install/
...
export PREFIX=$(pwd)
_RUN_CHECK_OK "Test space install: PREFIX set" "\[SUCCE\] SPACE_INSTALL_BIN:" space /install/
...
_RUN_CHECK_OK "Test space install: BIN_DEST set to relative path" "\[SUCCE\] SPACE_INSTALL_BIN:" space /install/ -- ./relativedir
...
_RUN_CHECK_OK "Test space install: BIN_DEST set to absolute path" "\[SUCCE\] SPACE_INSTALL_BIN:" space /install/ -- "$(pwd)"/absolutedir
...
_RUN_CHECK_OK "Test space install: BIN_DEST and AC_DEST set" "\[SUCCE\] SPACE_INSTALL_BIN:" space /install/ -- "$(pwd)"/customdir "$(pwd)"/customdir
