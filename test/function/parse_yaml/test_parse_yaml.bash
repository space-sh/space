...
_TEST_PARSE_YAML_CHECK_PARSED_YAML_OK()
{
    ...
    local _expected_result='_0a95env_0_BIN0a95PREFIX "/usr/local" _SPACEGAL_SAYS_END_OF_FINITY_ _0a95env_1_AC0a95PREFIX "/usr/share/bash-completion/completions" _SPACEGAL_SAYS_END_OF_FINITY_ _0a95info_title SpaceGal shell installer _SPACEGAL_SAYS_END_OF_FINITY_ _0a95info_desc Provides system wide installation and Bash auto-completion setup. Provides an uninstall utility for listing files originally installed by Space. _SPACEGAL_SAYS_END_OF_FINITY_ _0a95dep0a95install_0a95info_tite Verify Space dependencies _SPACEGAL_SAYS_END_OF_FINITY_ _0a95dep0a95install_0a95env_0_CMD SPACE_DEP_INSTALL _SPACEGAL_SAYS_END_OF_FINITY_ _install_0a95info_title Install SpaceGal shell _SPACEGAL_SAYS_END_OF_FINITY_ _install_0a95info_desc Perform SpaceGal shell install. Parameters (both optional):     1: BIN_PREFIX which is where the program and man page will be installed.     2: AC_PREFIX where the auto completion will be installed. Example (using default values):     ./space /install/ -- "/usr/local" "/usr/share/bash-completion/completions" _SPACEGAL_SAYS_END_OF_FINITY_ _install_0a95env_0_CMD SPACE_INSTALL _SPACEGAL_SAYS_END_OF_FINITY_ _uninstall_0a95info_title Uninstall SpaceGal shell _SPACEGAL_SAYS_END_OF_FINITY_ _uninstall_0a95info_desc Auto detects and lists all the files originally installed by SpaceGal shell. _SPACEGAL_SAYS_END_OF_FINITY_ _uninstall_0a95env_0_CMD SPACE_UNINSTALL _SPACEGAL_SAYS_END_OF_FINITY_'
